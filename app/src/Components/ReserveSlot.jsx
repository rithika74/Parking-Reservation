          ...
          try {
            ...
            if (selectedArea) {
              ...
              if (response.data) {
                setData('');
                console.log('success');
                navigate(`/userpage/slots/${selectedArea._id}`);
              }
            } else {
...
//         console.log('Selected area object:', selectedArea);
//         if (selectedArea) {
//           // If the selected area is found, navigate to slots page with its ID
//           const response = await axios.post('http://localhost:4000/reserve', data);
//           if (response.data) {
//             setData('');
//             console.log('success');
//             // Navigate to slots page with the reserved area's ID
//             navigate(`/userpage/slots/${selectedArea._id}`);
//           }
//         } else {
//           // If the selected area is not found, show an error message
//           toast.error('Selected area not found.');
//         }
//       } catch (error) {
//         console.error('Error:', error);
